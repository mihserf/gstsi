...
module Translate
  module Columns
    ...
    DEFAULT_LOCALE_CLASS_NAME = 'Localedb'
    ...
    module InstanceMethods
      ...
      def save( perform_validation = true )
        save_and_disable_translation( perform_validation )
        r = super
        enable_translation
        r
      end
      ...
      def save_and_disable_translation( perform_validation )
        translation.save( perform_validation ) if (translation)
        @disable_translation = true
      end
